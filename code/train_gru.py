...
from models_gru import GCN_RNN, GCN_RNN_BN
from utils import *
        ...
        for epoch in range(args.num_epochs):
            ...
            if prec > best_prec:
                ...
                torch.save(model.state_dict(), os.path.join(
                    args.model_path, 'miccai_gru_bn_64_1024_0.001_data2_model_best_exp-{}.ckpt'.format(exp_num)))
...
def test(data_loader, model, criterion, writer, exp_num):
    ...
    model.load_state_dict(torch.load(os.path.join(
                './models', 'miccai_gru_bn_64_1024_0.001_data2_model_best_exp-{}.ckpt'.format(exp_num))))
    model.eval()
    total_step = len(data_loader)
...
if __name__ == '__main__':
    folder_path = '/mount/wd/data/data_miccai'
    ...
    parser.add_argument('--feat_size', type=int , default=16, help='dimension of lstm hidden states')
